...
STZ $00 ; $00 = 0
SEP #$20
LDA #$FF : STA $2140 ; APU IO 0 = FFh (request APU upload)
REP #$20
...
ProcessDataBlock:
PHA : REP #$20
JSR GetDataAndIncY : TAX ; X = [[Y++]] (block size)
JSR IncY ; Y += 1
JSR GetDataAndIncY : STA $2142 ; APU IO 2..3 = [[Y++]] (destination address)
JSR IncY ; Y += 1
SEP #$20
...
- : CMP $2140 : BNE - ; Wait until APU IO 0 echoes
TXA : BNE UploadDataBlock ; If block size != 0: go to UploadDataBlock
PLB : PLP : RTS
GetDataAndIncY:
LDA [$00],y
IncY:
