...
; Taken from https://github.com/amoebaOfDoom/subversion/blob/master/Project/ASM/RNG.asm,
; but t1 is moved to $3F to avoid a conflict with "transfer samus tiles optimization + animated tiles fix 1.2.asm".
